...
import org.springframework.data.examples.boot.process.ProcessServiceImpl;
import org.springframework.data.examples.boot.storage.jpa.domain.Customer;
import org.springframework.data.examples.boot.storage.jpa.service.CustomerService;
import org.springframework.data.examples.boot.storage.neo4j.domain.Person;
import org.springframework.data.examples.boot.storage.neo4j.service.PersonService;
